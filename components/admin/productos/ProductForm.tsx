...
export default function ProductForm({
  ...
  const handleMediaUpload = useCallback(async (files: FileList | null) => {
    ...
    if (oversizedFiles.length > 0) {
      toast.error(`${oversizedFiles.length === 1 ? 'El archivo' : 'Los archivos'} supera${oversizedFiles.length === 1 ? '' : 'n'} el límite de 2 MB. Por favor reduce el tamaño antes de subir.`)
      return
    }
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                disabled={saving}
                className="bg-primary-dark text-white hover:bg-black font-bold rounded-xl h-9 shadow-md text-xs gap-2"
              >
