...
import { PageTransition, FadeIn, FadeInDirection, ScaleIn } from '@/components/motion'
...
// Server Component: this page is 100% static copy, no interactivity of its
// own — only the entrance animations need a client boundary, so those are
// delegated to the shared FadeIn/FadeInDirection/ScaleIn client wrappers
// from @/components/motion instead of marking the whole page 'use client'.
      ...
      <section className="relative pt-12 pb-20 overflow-hidden">
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <ScaleIn className="inline-flex items-center gap-2 px-4 py-2 bg-nurei-cta/10 text-nurei-cta rounded-full text-xs font-bold uppercase tracking-widest">
      ...
      <section className="py-24 bg-gray-50/50">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeInDirection direction="left" className="space-y-12">
            ...
            <ScaleIn className="relative aspect-square rounded-[3rem] bg-nurei-cta overflow-hidden shadow-2xl rotate-3">
