...
interface MenuClientProps {
  ...
  initialCategoryMeta: Record<string, MenuCategoryMeta>
}

export function MenuClient({ initialProducts, initialCategoryOrder, initialCategoryMeta }: MenuClientProps) {
  ...
  const [categoryOrder] = useState<string[]>(initialCategoryOrder)
  const [categoryMeta] = useState<Record<string, { label: string; emoji: string; color?: string }>>(initialCategoryMeta)
