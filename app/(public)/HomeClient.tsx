...
import { ArrowRight, Check, Plus, ChevronRight, Ban } from 'lucide-react'
...
export function HomeClient({ initialProducts, initialCategories, storeSlogan }: HomeClientProps) {
