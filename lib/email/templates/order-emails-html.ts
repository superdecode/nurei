        ...
        <tr><td style="padding:24px;">
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px auto 0;">
            <tr><td align="center" bgcolor="${BRAND_AMBER}" style="border-radius:14px;mso-padding-alt:14px 28px;">
              <a href="${escapeHtml(p.orderUrl)}" target="_blank" rel="noopener noreferrer" style="display:inline-block;padding:14px 30px;font-size:15px;font-weight:800;color:${TEXT_DARK};text-decoration:none;border:none;border-radius:14px;background-color:${BRAND_AMBER};background-image:linear-gradient(135deg,#FFC107 0%,#FFD75A 100%);box-shadow:0 9px 24px rgba(255,193,7,.38);">Ver mi pedido →</a>
            </td></tr>
          </table>
